...
export default function AddTransactionModal({ showModal = true, setShowModal = () => {} }) {
  ...
  return (
    <div
      className={`fixed inset-0 w-full h-screen backdrop-blur-sm bg-white/30 transition-opacity duration-300 z-50 overflow-y-hidden ${isVisible ? "bg-opacity-50" : "bg-opacity-0"}`}
      onClick={handleClose}>
        ...
        <div
          ...
          <div className="p-6 space-y-3">
            ...
            <div className="space-y-2">
              ...
              />
              {errors.category && <p className="text-red-500 text-category text-sm animate-pulse">{errors.category}</p>}
            </div>
            ...
            <div className="flex gap-3">
              <button
                type="button"
                onClick={handleClose}
                className="flex-1 px-6 py-3 border-2 border-gray-300 text-gray-700 rounded-xl font-medium transition-all duration-200 hover:bg-gray-50 hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-300 cursor-pointer">
                Cancel
              </button>
              <button
                type="submit"
